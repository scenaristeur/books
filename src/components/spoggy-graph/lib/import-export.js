...
export function rdf2Xml(data, network){
...
export function ttl2Xml(data,network){
  // reprise de https://github.com/scenaristeur/graphe/blob/master/js/conversion.js
  console.log(data);
  var sujet, propriete, objet;
  var triplets = [];
  var prefixes=[];
  var base="";
  var separateur="";
...
export function addNodeIfNotExist(network, data){
  var existNode = false;
  console.log(data);
  try{
...
export function parseRdfNode(data, triplets){
...
export function parseObjectProperty(data, triplets){
...
export function parseOwlNamedIndividual(data, triplets){
  //  console.log("-----------------------------\n--------------------\n");
  //  console.log(data);
...
export function parseRdfOther(data, triplets){
...
export function parseRdfsClass(data, triplets){
  //  console.log("-----------------------------\n--------------------\n");
  //  console.log(data);
